...
namespace BiendeoCHLib.Wrappers {
	...
	public struct BasePlayerWrapper {
		...
		public NoteWrapper[] HittableNotes => ((object[])hittableNotesField.GetValue(BasePlayer)).Select(o => NoteWrapper.Wrap(o)).ToArray();
		[WrapperField("\u0315\u0318\u0315\u030F\u0310\u031A\u0310\u031B\u0316\u0312\u0315")]
		private static readonly FieldInfo hittableNotesField;

		public List<NoteWrapper> Notes => ((ICollection)notesField.GetValue(BasePlayer))?.Cast<object>().Select(o => NoteWrapper.Wrap(o)).ToList();
