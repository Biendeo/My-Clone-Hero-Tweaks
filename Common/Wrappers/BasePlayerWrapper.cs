...
namespace Common.Wrappers {
	...
	internal class BasePlayerWrapper : WrapperBase {
		...
		private static FieldInfo unknownBool2Field; // bool 3 Initially true, literally not used otherwise. It is public though.

		public bool UnknownBool4 => (bool)unknownBool4Field.GetValue(basePlayer);
		[WrapperField("\u0313\u0319\u0310\u0318\u0316\u0311\u031A\u0312\u0313\u0311\u0310")]
		private static FieldInfo unknownBool4Field; // bool 4 Only used in Update.
		...
		private static FieldInfo unknownBool1Field; // bool 7
		...
		private static FieldInfo unknownInt6Field; //? Always 0?
